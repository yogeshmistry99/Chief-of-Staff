      ...
      <div className="flex-1 overflow-y-auto px-4 pt-5 pb-2 max-w-lg mx-auto w-full">
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          {[
            ...
            { label: 'Events',   value: '—',                           color: 'bg-[#D3E4FF] text-[#001D36]' },
        ...
        {/* Priority list */}
        <div className="bg-white border border-[#CAC4D0] rounded-2xl p-4 mb-3">
        ...
        <div className="bg-white border border-[#CAC4D0] rounded-2xl p-4 mb-4">
          ...
          <p className="text-xs text-[#79747E] mt-3">Connect Google Calendar in Settings.</p>
        </div>
      </div>
